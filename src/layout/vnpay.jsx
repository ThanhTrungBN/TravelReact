...
import { addOrder, VnPay } from '../services/order.service.js'
import { formatDate,formatNumber } from "../constant/help.js";
const PayTest = function () {
    ...
    const handleSubmit = async (e) => {
        try {
            const dataToSend = {
                ...
                payment: {
                    orderType: tour.danhmucID,
                    amount: parseFloat(finalSume),
                    orderDescription: tour.tieudetour,
                    name:  hovatenRef.current.value,
                }
            };
            const result = await VnPay(dataToSend);
                                    ...
                                    <div class="detail">
                                        <table>
                                            ...
                                            <tbody>
                                                ...
                                                <tr class="total">
                                                    <td>Tổng tiền </td>
                                                    <td class="t-price text-right">{formatNumber(finalSume)}&nbsp;₫</td>
                                                </tr>
                                            </tbody>
                                        </table><button onClick={handleSubmit} class="btn btn-primary btn-order">Đặt ngay</button>
                                    </div>
                                </div>
                            </div>
                        </div>
