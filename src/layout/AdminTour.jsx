...
import { loadTourMoi } from '../services/admin.services.js';
import { deleteTour } from '../services/admin.services.js';
...
const AdminTour = function () {
    ...
    const handleDeleteTour = async (matour) => {
        try {
            await deleteTour(matour);
            setTours(tours.filter(tour => tour.matour !== matour));
                                            ...
                                            <tr key={tour.matour} >
                                                ...
                                                <td>
                                                    <div className={styles.item}>
                                                        ...
                                                        <span style={{ whiteSpace: 'nowrap' }}>{formatDate(tour.ngaythangnam)}</span>
                                                    </div>
                                                    <div className={styles.item}>
                                                ...
                                                <td>
                                                    <div style={{ display: 'flex' }}>
                                                        <FontAwesomeIcon icon={faTrash} style={{ color: 'red', fontSize: '18px', padding: '10px' }} onClick={() => handleDeleteTour(tour.matour)} />
                                                        <FontAwesomeIcon icon={faPen} style={{ color: '#0A97BB', fontSize: '18px', padding: '10px' }} onClick={() => handleEditTour(tour.matour)} />
                                                    </div>
                                                </td>
                                            </tr>
                                        ))}
