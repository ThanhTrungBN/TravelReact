...
import { addTour } from '../services/admin.services'
import {TravelMenu} from '../constant/context'
const AdminCreate = function () {
        ...
        <div id="content-wrapper" className={`${styles['d-flex']} ${styles['flex-column']}`} style={{ width: '100%' }}>
            <div id="content">
                ...
                <div className={styles['container-fluid']}>
                    <h1 className={`${styles.h3} ${styles['mb-2']} ${styles['text-gray-800']}`}>Thêm Thông Tin Tour Du Lịch</h1>
                        ...
                        <div className={styles['card-body']}>
                            <form method="POST" onSubmit={handleSubmit}>
                                ...
                                <div className={styles['form-group']}>
                                    ...
                                    <input type="text" name="danhmucid" id="danhmucid" className={styles['form-control']} />
                                </div>
                                <div className={styles.row}>
                                    <div className={styles['col-md-6']}>
                                        <div className={styles['form-group']}>
                                            ...
                                            <input type="text" name="tieudetour" id="tieudetour" className={styles['form-control']} />
                                        </div>
                                    </div>
                                    <div className={styles['col-md-6']}>
                                        <div className={styles['form-group']}>
                                            <label>Mã Tour</label>
                                            <input type="text" name="matour" id="matour" className={styles['form-control']} />
                                        </div>
                                    </div>
                                </div>
                                <div className={styles.row}>
                                    <div className={styles['col-md-6']}>
                                        <div className={styles['form-group']}>
                                            ...
                                            <input type="text" name="Gia" id="Gia" className={styles['form-control']} />
                                        </div>
                                    </div>
                                    <div className={styles['col-md-6']}>
                                        <div className={styles['form-group']}>
                                            <label>Nơi khởi hành</label>
                                            <input type="text" name="noikhoihanh" id="noikhoihanh" className={styles['form-control']} />
                                        </div>
                                    </div>
                                </div>
                                <div className={styles.row}>
                                    <div className={styles['col-md-6']}>
                                        <div className={styles['form-group']}>
                                            ...
                                            <input type="number" name="sochoconnhan" id="sochoconnhan" className={styles['form-control']} />
                                        </div>
                                    </div>
                                    <div className={styles['col-md-6']}>
                                        <div className={styles['form-group']}>
                                            <label>Số ngày đi</label>
                                            <input type="text" name="songaydi" id="songaydi" className={styles['form-control']} />
                                        </div>
                                    </div>
                                </div>
                                <div className={styles.row}>
                                    <div className={styles['col-md-12']}>
                                        <div className={styles['form-group']}>
                                            ...
                                            <input type="text" name="madanhmuctour" id="madanhmuctour" className={styles['form-control']} />
                                        </div>
                                        <div className={styles['form-group']}>
                                            <label>Ngày Bắt Đầu
                                                <span title="Tên sản phẩm không bao gồm các giá trị thuộc tính như màu sắc, chất liệu, kích cỡ...">
                                            ...
                                            <input type="date" name="ngaythangnam" id="ngaythangnam" className={styles['form-control']} />
                                        </div>
                                        <div className={styles['form-group']}>
                                            <label>Ảnh Đại diện
                                                <span title="Tên sản phẩm không bao gồm các giá trị thuộc tính như màu sắc, chất liệu, kích cỡ...">
                                            ...
                                            <input type="text" name="anhdaidien" id="anhdaidien" className={styles['form-control']} />
                                        </div>
                                    </div>
                                </div>
                                <button type="submit" className={`${styles.btn} ${styles['btn-primary']} ${styles['text-right']}`}>Tạo</button>
                            </form>
                        </div>
                    </div>
                </div>
